...
// Provided calculateColumntotal() tests
   ...
   //Testing for createNumberArray()
    ...
    public void testCreateNumberArrayWithExpectedNulls() {
        ...
        // Check first element is correctly converted
        ...
        // Expect null at index 1 due to known behavior with Double.MIN_VALUE
    ...
    public void testCreateNumberArray2DWithSpecialValues() {
        ...
        for (Number[] row : result) {
            for (Number cell : row) {
                ...
                // and then proceed to assert specific floating-point behavior
                if (cell != null) {
