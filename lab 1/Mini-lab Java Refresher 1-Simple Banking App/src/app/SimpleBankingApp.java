...
public class SimpleBankingApp {
	...
	public static void printAllAccounts() {
		...
		for (Account account : accounts) {
	        // Assuming Account's toString method returns a formatted string except for balance
	        String formattedAccount = account.toString();
	        String balanceFormatted = String.format("$%.2f", getBalance(account.getAccount_holder()));

	        System.out.println(formattedAccount + " | " + balanceFormatted);
	    }
	...
	///TODO 7 
	//Problem was that account number was actually named - GetAccoun_holder() 
	//in account class, however in this code there was a call for 
	//getAccount_number rather than getAccoun_holder
